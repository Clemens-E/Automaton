...
module.exports.run = async (client, message) => {
    ...
    const logchannel = client.logchannel(message.guild.id);
    ...
    const embed = new Discord.RichEmbed().setColor(client.config.ci).setDescription(`${message.member} wrote a highlighted Word\nChat History:\n\`\`\`${output.join('\n')}\`\`\``);
